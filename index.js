...
console.log(`${homeGoals / data.length} Home Goal Average`)
console.log(`${awayGoals / data.length} Away Goal Average`)
};
...
/* Stretch 4: Write a function called badDefense() that accepts a parameter `data` and calculates the team with the most goals scored against them per
 appearance (average goals against) in the World Cup finals */
